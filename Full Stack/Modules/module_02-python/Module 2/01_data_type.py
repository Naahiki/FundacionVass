...
users = ["Cristina", "June", "Nahiki"]
print(users)                    # [ 'Cristina', 'June', 'Nahiki' ]

# INSERT NEW ELEMENTS
users.insert(2, "Raquel")       # [ 'Cristina', 'June', 'Raquel', 'Nahiki' ] -> insert in index = 2
users.append("Thom")            # [ 'Cristina', 'June', 'Raquel', 'Nahiki', 'Thom' ] -> insert at the end

# ACCESS ELEMENTS
print(users[3])                 # Nahiki
print([users[3]])               # ['Nahiki']

# EDIT VALUES
users[4] = "Irene"
print(users)                    # [ 'Cristina', 'June', 'Raquel', 'Nahiki', 'Irene' ]

# REMOVE ELEMENTS FROM THE LIST
# .remove() -> when you know the value to remove
users.remove("Raquel")
print(users)                    # ['Cristina', 'June', 'Nahiki', 'Irene']
